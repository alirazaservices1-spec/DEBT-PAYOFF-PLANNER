    ...
    return (
      <Animated.View style={{ width: size, height: h, transform: [{ translateY }, { scale }, { rotate }] }}>
        <Svg width={size} height={h} viewBox="0 0 120 160">
          ...
          <Path d="M24 50 Q40 45 56 50" fill="none" stroke="#2A1808" strokeWidth={2.4} strokeLinecap="round" />
          <Path d="M64 50 Q80 45 96 50" fill="none" stroke="#2A1808" strokeWidth={2.4} strokeLinecap="round" />

          <Ellipse cx={26} cy={80} rx={10} ry={6.5} fill="#E87070" opacity={0.18} />
          <Ellipse cx={94} cy={80} rx={10} ry={6.5} fill="#E87070" opacity={0.18} />

          <Path d="M40 90 Q60 103 80 90" fill="none" stroke="#2A1808" strokeWidth={3.2} strokeLinecap="round" />
    ...
    return (
      <Animated.View style={{ width: size, height: h, transform: [{ translateY }, { scale }, { rotate }] }}>
        <Svg width={size} height={h} viewBox="0 0 140 170">
          ...
          <Path d="M34 60 Q46 56 58 60" fill="none" stroke="#2A1808" strokeWidth={2.6} strokeLinecap="round" />
          <Path d="M82 60 Q94 56 106 60" fill="none" stroke="#2A1808" strokeWidth={2.6} strokeLinecap="round" />
    ...
    return (
      <Animated.View style={{ width: size, height: size * 1.2, transform: [{ translateY }, { scale }, { rotate }] }}>
        <Svg viewBox="0 0 120 145" width={size} height={size * 1.2}>
          ...
          <Path d="M42 86 Q60 96 78 86" fill="none" stroke="#2A1808" strokeWidth={3} strokeLinecap="round" />
    ...
    return (
      <Animated.View style={{ width: size, height: size * 1.2, transform: [{ translateY }, { scale }, { rotate }] }}>
        <Svg viewBox="0 0 120 145" width={size} height={size * 1.2}>
          ...
          <Path d="M38 89 Q60 103 82 89" fill="none" stroke="#2A1808" strokeWidth={3.5} strokeLinecap="round" />
    ...
    return (
      <Animated.View style={{ width: size, height: size * 1.2, transform: [{ translateY }, { scale }, { rotate }] }}>
        <Svg viewBox="0 0 120 145" width={size} height={size * 1.2}>
          ...
          <Path d="M38 90 Q60 106 82 90" fill="none" stroke="#2A1808" strokeWidth={3.5} strokeLinecap="round" />
          <Rect x={29} y={113} width={22} height={12} rx={6} fill="#C4A878" />
          <Rect x={69} y={113} width={22} height={12} rx={6} fill="#C4A878" />
    ...
    return (
      <Animated.View style={{ width: size, height: size * 1.2, transform: [{ translateY }, { scale }, { rotate }] }}>
        <Svg viewBox="0 0 120 145" width={size} height={size * 1.2}>
          ...
          <Path d="M40 87 Q60 98 78 87" fill="none" stroke="#2A1808" strokeWidth={3} strokeLinecap="round" />
  ...
  return (
    <Animated.View style={{ width: size, height: size * 1.06, transform: [{ translateY }, { scale }, { rotate }] }}>
      <Svg viewBox="0 0 170 180" width={size} height={size * 1.06}>
        ...
        <Path d={brows.l} stroke="#2A1808" strokeWidth={4} fill="none" strokeLinecap="round" />
        <Path d={brows.r} stroke="#2A1808" strokeWidth={4} fill="none" strokeLinecap="round" />
        ...
        {mood === "celebrating" && (
          <>
            ...
            <Path d="M85 130 L85 147" stroke="#2A1808" strokeWidth={2} />
          </>
        )}
