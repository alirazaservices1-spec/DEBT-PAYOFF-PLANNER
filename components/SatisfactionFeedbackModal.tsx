          ...
          <View style={[s.card, { height: cardH }]}>
            ...
            {step === "feedback" && (
                <ScrollView
                  ...
                  showsVerticalScrollIndicator={false}
                  keyboardShouldPersistTaps="handled"
                  contentContainerStyle={[s.feedbackScrollOuter, { paddingBottom: insets.bottom + 12 }]}
                >
                  {/* Back button */}
                  <Pressable
                  ...
                  <Text style={[s.popHl, s.popHlSm, { color: INK }]}>
                    {"Help us fix it.\n"}
                    <Text style={s.popHlEmDark}>{"What happened?"}</Text>
                  </Text>
                  ...
                  <Pressable
                    style={[s.btnPWrap, { marginTop: 4 }, !consent && { opacity: 0.38 }]}
                    onPress={submitFeedback}
                    disabled={!consent}
                  >
                    <LinearGradient
                      colors={["#1F7AE0", "#145FB6"]}
                      start={{ x: 0.13, y: 0 }}
                      end={{ x: 1, y: 1 }}
                      style={s.btnPGrad}
                    >
            ...
            {step === "thanks" && (
              ...
              >
                <DexWarm />
                <Text style={s.thanksPopHl}>
                  {"Got it.\n"}
                  <Text style={s.thanksPopHlEm}>Thank you.</Text>
                </Text>
                <Text style={s.thanksPopBody}>
...
const s = StyleSheet.create({
  ...
  awm: { fontFamily: Fonts.serif, fontStyle: "italic", fontSize: 15, color: NAVY },
  badgeXp: {
  ...
  popHlSm: { fontSize: 21, lineHeight: 28 },
  popHlEm: { fontStyle: "italic", color: AMBER_D },
  popHlEmDark: { fontStyle: "italic", color: INK },
  ...
  /** Thank-you screen only: larger, true black for readability */
  thanksPopHl: {
    fontFamily: Fonts.serif,
    fontSize: 32,
    color: "#000000",
  ...
  thanksPopHlEm: { fontStyle: "italic", color: "#000000" },
  thanksPopBody: {
    fontFamily: Fonts.regular,
    fontSize: 18,
    color: "#000000",
  ...
  sentEmoji: { fontSize: 22, lineHeight: 26 },
  sentLabel: { fontFamily: Fonts.semiBold, fontSize: 17, color: NAVY, lineHeight: 22 },
  ...
  chipTxt: { fontFamily: Fonts.semiBold, fontSize: 14, color: INK },
  ...
  consentLink: { color: "#145FB6", fontFamily: Fonts.semiBold },
  ...
  btnPTxt: { fontFamily: Fonts.bold, fontSize: 16, color: "white" },
  btnS: {
    width: "100%",
    borderRadius: 13,
    paddingVertical: 10,
  ...
  btnSTxt: { fontFamily: Fonts.semiBold, fontSize: 14, color: INK },
  ...
  closingEm: { color: "#000000", fontFamily: Fonts.bold },
