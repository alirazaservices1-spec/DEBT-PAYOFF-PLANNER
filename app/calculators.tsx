...
const inputStyles = StyleSheet.create({
  wrap: { gap: 4 },
  label: { fontSize: 13, fontFamily: Fonts.semiBold, fontWeight: "600" },
  row: {
    flexDirection: "row",
    alignItems: "center",
    borderWidth: 1,
  ...
  affix: { fontSize: 15, fontFamily: Fonts.semiBold, fontWeight: "600", marginHorizontal: 4 },
});
...
const rStyles = StyleSheet.create({
  ...
  label: { fontSize: 14 },
  value: { fontSize: 15, fontFamily: Fonts.bold, fontWeight: "700" },
});
...
const sStyles = StyleSheet.create({
  ...
  title: { fontSize: 17, fontFamily: Fonts.bold, fontWeight: "700" },
});
...
export default function CalculatorsScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: C.background }]}>
      {/* Fixed nav bar */}
      <View style={[styles.navBar, { paddingTop: Platform.OS === "web" ? webTopPad : insets.top, backgroundColor: C.background, borderBottomColor: C.border }]}>
        ...
        <Text style={[styles.navTitle, { color: C.text }]}>Calculators</Text>
        <View style={{ width: 72 }} />
      </View>
